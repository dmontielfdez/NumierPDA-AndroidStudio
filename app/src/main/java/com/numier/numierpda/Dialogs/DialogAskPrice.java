...
public class DialogAskPrice extends DialogFragment implements View.OnClickListener {
    ...
    public DialogAskPrice(Product product, Detalle detail) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.buttonOkDialogKeyboard:
                ...
                this.detail.setPrice(value / 100);

                IntakeTools.launchDialogWeight(product, detail);
                getDialog().cancel();
