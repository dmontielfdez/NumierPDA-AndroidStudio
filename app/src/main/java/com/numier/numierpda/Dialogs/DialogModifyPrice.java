...
public class DialogModifyPrice extends DialogFragment implements View.OnClickListener {
    ...
    public DialogModifyPrice(Detalle detail, int position) {
        this.detail = detail;
        ...
        switch (v.getId()) {
            ...
            case R.id.buttonOkDialogKeyboard:
                ...
                double value = Double.parseDouble(countInteger.toString() + countDecimal.toString());
                    ...
                    Cash.getTicketFragment().getDetails().get(position).setPrice(value / 100);
    ...
    private void setNewValue(int value) {
        if (decimalActivated) {
            ...
            switch (countDecimal.length()) {case 0:
